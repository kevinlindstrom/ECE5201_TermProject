...
E3 = [exp(1j*(2*m+1)*pi)*T12_e*T23_e; T12_o*T23_o; 0]*...
...
patch([xp nan], [yp nan], [zp nan], [zp nan] ,'FaceColor','none', ...
    'EdgeColor','interp')
xlabel("$x$ (V/m)", 'Interpreter','latex', 'FontSize', 100)
ylabel("$y$ (V/m)", 'Interpreter','latex', 'FontSize', 100)
zlabel("$z$ ($\mu$ m)", 'Interpreter','latex', 'FontSize', 100)
title("Electric Field \textbf{E}$(z; t = 0)$ in HWP", 'Interpreter', ...
    'latex', 'FontSize', 100)
grid on
ax = gca;
ax.FontSize = 20;
